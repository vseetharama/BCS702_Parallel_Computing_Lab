...
int main(){
    ...
    printf("\n Difference(Sequential-Parallel):%f secods\n",time_seq-time_par);
...
// PS D:\bcs702_parallel_computing> gcc -fopenmp Lab1.c -o Lab1
// PS D:\bcs702_parallel_computing> ./Lab1.exe                 
// Sorting 9000 elements...

// Sequential Merge Sort Time : 0.002000 seconds
// Parallel Merge Sort Time : 0.002000 seconds

//  Difference(Sequential-Parallel):0.000000 secods
// Speedup: 1.00x

//  Verification: First 20 elemnts of the sorted array:
// 01123345557799101111121313
// PS D:\bcs702_parallel_computing> 
